...
{if $loggedIn && !$genericuser }
    ...
    {/if}
        ...
        <div id="newaddress" style="clear:left; {if count($addressbook)}display: none;{/if}" role="form">
            <form method="post" action="cart/checkout/" class="horizontal-form">
                <h3>Add Address</h3>

            <div class="form-fieldset form-group{if $errors.new_firstname} error{/if}">
                <label for="new_firstname">First name</label>
                <input type="text" class="form-control input text" size="20" name="new[firstname]" maxlength="20" id="new_firstname" value="{if $fields.new_firstname}{$fields.new_firstname}{elseif $user.us_firstname}{$user.us_firstname}{/if}" /> *<br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_lastname} error{/if}">
                <label for="new_lastname">Last name</label>
                <input type="text" class="form-control input text" size="20" name="new[lastname]" maxlength="20" id="new_lastname" value="{if $fields.new_lastname}{$fields.new_lastname}{elseif $user.us_lastname}{$user.us_lastname}{/if}" /> *<br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_company} error{/if}">
                <label for="new_company">Company Name</label>
                <input type="text" class="form-control input text" size="30" name="new[company]" maxlength="35" id="new_company" value="{if $fields.new_company}{$fields.new_company}{elseif $user.us_company}{$user.us_company}{/if}" /><br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_email} error{/if}">
                <label for="new_email">Email</label>
                <input type="email" class="form-control input text" size="30" name="new[email]" maxlength="85" id="new_email" value="{if $fields.new_email}{$fields.new_email}{elseif $user.us_email}{$user.us_email}{/if}" /> *<br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_phone} error{/if}">
                <label for="new_phone">Phone Number</label>
                <input type="text" class="form-control input text" size="30" name="new[phone]" maxlength="85" id="new_phone" value="{if $fields.new_phone}{$fields.new_phone}{elseif $user.us_phone}{$user.us_phone}{/if}" /><br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_country} error{/if}">
                <label for="new_country">Country</label>
                <select class="form-control select required" name="new[country]" id="new_country" onchange="updateCountry($(this).val(), 'new');">
            ...
            <div class="form-fieldset form-group{if $errors.new_state} error{/if}">
                <label for="new_state">State</label>
                <input type="text" class="form-control input text" size="20" name="new[state]" maxlength="35" id="new_state" value="{if $fields.new_state}{$fields.new_state}{elseif $user.us_state}{$user.us_state}{/if}" /><br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_address1} error{/if}">
                <label for="new_address1">Address 1</label>
                <input type="text" class="form-control input text" size="30" name="new[address1]" maxlength="35" id="new_address1" value="{if $fields.new_address1}{$fields.new_address1}{elseif $user.us_address1}{$user.us_address1}{/if}" /> *<br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_address2} error{/if}">
                <label for="new_address2">Address 2</label>
                <input type="text" class="form-control input text" size="30" name="new[address2]" maxlength="35" id="new_address2" value="{if $fields.new_address2}{$fields.new_address2}{elseif $user.us_address2}{$user.us_address2}{/if}" /><br />
            </div>

             <div class="form-fieldset form-group{if $errors.new_suburb} error{/if}">
               <label for="new_suburb">Suburb</label>
                <input type="text" class="form-control input text" size="20" name="new[suburb]" maxlength="35" id="new_suburb" value="{if $fields.new_suburb}{$fields.new_suburb}{elseif $user.us_suburb}{$user.us_suburb}{/if}" /><br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_city} error{/if}">
                <label for="new_city">City</label>
                <input type="text" class="form-control input text" size="20" name="new[city]" maxlength="35" id="new_city" value="{if $fields.new_city}{$fields.new_city}{elseif $user.us_city}{$user.us_city}{/if}" /> *<br />
            </div>

            <div class="form-fieldset form-group{if $errors.new_postcode} error{/if}">
                <label for="new_postcode">Postcode</label>
                <input type="text" class="form-control input text" size="10" name="new[postcode]" id="new_postcode" value="{if $fields.new_postcode}{$fields.new_postcode}{elseif $user.us_postcode}{$user.us_postcode}{/if}" /> *<br />
            </div>
          ...
          {foreach from=$freightoptions item=fo}
            ...
            {if $fo=='Forwarder'}
                ...
                <p id="new_freightforwarding" {if $fields.new_freight_method != 'forwarding'}style="display:none"{/if}>
                    ...
                    <input type="text" class="form-control input text" size="20" name="new[freight_company]" id="new_freight_company" value="{if isset($fields.new_freight_company)}{$fields.new_freight_company}{elseif $loggedIn}{$userrecord.us_firstname}{/if}" /><br />
    {if $errors.new_freight_company}<span class="error">{$errors.new_freight_company}</span><br/>{/if}
                    ...
                    <input type="text" class="form-control input text" size="20" name="new[freight_accountno]" id="new_freight_accountno" value="{$fields.new_freight_accountno}" /><br />
    {if $errors.new_freight_accountno}<span class="error">{$errors.new_freight_accountno}</span><br/>{/if}
                    ...
                    <input type="text" class="form-control input text" size="20" name="new[freight_ordernumber]" id="new_freight_ordernumber" value="{$fields.new_freight_ordernumber}" /><br />
...
{else}
    ...
    <form id="customer-details" method="post" action="cart/checkout/" class="contact-form no-ajax"  role="form">
        <fieldset id="shipping-details">
            ...
            <div class="form-fieldset form-group{if $errors.shipping_firstname} error{/if}">
                ...
                <input type="text" class="form-control input text required" name="shipping_firstname" id="shipping_firstname" value="{if $fields.shipping_firstname}{$fields.shipping_firstname}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_lastname} error{/if}">
                ...
                <input type="text" class="form-control input text required" name="shipping_lastname" id="shipping_lastname" value="{if $fields.shipping_lastname}{$fields.shipping_lastname}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.shipping_company} error{/if}">
                <label for="shipping_company" class="control-label">Company Name</label>
                <input type="text" class="form-control input text" name="shipping_company" id="shipping_company" value="{if $fields.shipping_company}{$fields.shipping_company}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_email} error{/if}">
                ...
                <input type="email" class="form-control input email required" name="shipping_email" id="shipping_email" value="{if $fields.shipping_email}{$fields.shipping_email}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_phone} error{/if}">
               <label for="shipping_phone" class="control-label">Phone Number</label>
                <input type="text" class="form-control input text" name="shipping_phone" id="shipping_phone" value="{if $fields.shipping_phone}{$fields.shipping_phone}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_country} error{/if}">
             ...
             <div class="form-fieldset form-group{if $errors.shipping_state} error{/if}{if $shippingnostates} hidden{/if}">
                ...
                <input type="text" class="form-control input text" name="shipping_state" id="shipping_state" value="{if $fields.shipping_state}{$fields.shipping_state}{/if}" />
                {/if}
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_address1} error{/if}">
                ...
                <input type="text" class="form-control input text required" name="shipping_address1" id="shipping_address1" value="{if $fields.shipping_address1}{$fields.shipping_address1}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_address2} error{/if}">
                ...
                <input type="text" class="form-control input text" name="shipping_address2" id="shipping_address2" value="{if $fields.shipping_address2}{$fields.shipping_address2}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_suburb} error{/if}">
                ...
                <input type="text" class="form-control input text" name="shipping_suburb" id="shipping_suburb" value="{if $fields.shipping_suburb}{$fields.shipping_suburb}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_city} error{/if}">
                ...
                <input type="text" class="form-control input text required" name="shipping_city" id="shipping_city" value="{if $fields.shipping_city}{$fields.shipping_city}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.shipping_postcode} error{/if}">
                ...
                <input type="text" class="form-control input text required" name="shipping_postcode" id="shipping_postcode" value="{if $fields.shipping_postcode}{$fields.shipping_postcode}{/if}" />
            </div>
          ...
          {foreach from=$freightoptions item=fo}
            ...
            {if $fo=='Forwarder'}
                ...
                <p id="new_freightforwarding" {if $fields.new_freight_method != 'forwarding'}style="display:none"{/if}>
                    ...
                    <label for="new_freight_accountno">Account Number</label>
                    <input type="text" class="form-control input text" size="20" name="new[freight_accountno]" id="new_freight_accountno" value="{if $fields.new_freight_accountno}{$fields.new_freight_accountno}{/if}" /><br />
                    {if $errors.new_freight_accountno}<span class="error">{$errors.new_freight_accountno}</span><br/>{/if}

                    <label for="new_freight_ordernumber">Order Number</label>
                    <input type="text" class="form-control input text" size="20" name="new[freight_ordernumber]" id="new_freight_ordernumber" value="{if $fields.new_freight_ordernumber}{$fields.new_freight_ordernumber}{/if}" /><br />
                    {if $errors.new_freight_ordernumber}<span class="error">{$errors.new_freight_ordernumber}</span><br/>{/if}
                </p>
             {/if}
          {/foreach}
    ...
    <fieldset id="billing-details">
            ...
            <div class="form-fieldset form-group{if $errors.billing_firstname} error{/if}">
                <label for="billing_firstname" class="control-label">First name<span class="required">*</span></label>
                <input type="text" class="form-control input text required" name="billing_firstname" id="billing_firstname" value="{if $fields.billing_firstname}{$fields.billing_firstname}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_lastname} error{/if}">
                <label for="billing_lastname" class="control-label">Last name<span class="required">*</span></label>
                <input type="text" class="form-control input text required" name="billing_lastname" id="billing_lastname" value="{if $fields.billing_lastname}{$fields.billing_lastname}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_company} error{/if}">
                <label for="billing_company" class="control-label">Company Name</label>
                <input type="text" class="form-control input text" name="billing_company" id="billing_company" value="{if $fields.billing_company}{$fields.billing_company}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_email} error{/if}">
                <label for="billing_email" class="control-label">Email<span class="required">*</span></label>
                <input type="email" class="form-control input email required" name="billing_email" id="billing_email" value="{if $fields.billing_email}{$fields.billing_email}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_phone} error{/if}">
               <label for="billing_phone" class="control-label">Phone Number</label>
                <input type="text" class="form-control input text" name="billing_phone" id="billing_phone" value="{if $fields.billing_phone}{$fields.billing_phone}{/if}" />
            </div>
            ...
            <div class="form-fieldset form-group{if $errors.billing_country} error{/if}">
             ...
             <div class="form-fieldset form-group{if $errors.billing_state} error{/if}">
               <label for="billing_state" class="control-label">State</label>
                <input type="text" class="form-control input text" name="billing_state" id="billing_state" value="{if $fields.billing_state}{$fields.billing_state}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_address1} error{/if}">
                <label for="billing_address1" class="control-label">Address 1<span class="required">*</span></label>
                <input type="text" class="form-control input text required" name="billing_address1" id="billing_address1" value="{if $fields.billing_address1}{$fields.billing_address1}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_address2} error{/if}">
                <label for="billing_address2" class="control-label">Address 2</label>
                <input type="text" class="form-control input text" name="billing_address2" id="billing_address2" value="{if $fields.billing_address2}{$fields.billing_address2}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_suburb} error{/if}">
                <label for="billing_suburb" class="control-label">Suburb</label>
                <input type="text" class="form-control input text" name="billing_suburb" id="billing_suburb" value="{if $fields.billing_suburb}{$fields.billing_suburb}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_city} error{/if}">
                <label for="billing_city" class="control-label">City<span class="required">*</span></label>
                <input type="text" class="form-control input text required" name="billing_city" id="billing_city" value="{if $fields.billing_city}{$fields.billing_city}{/if}" />
            </div>

            <div class="form-fieldset form-group{if $errors.billing_postcode} error{/if}">
                <label for="billing_postcode" class="control-label">Postcode<span class="required">*</span></label>
                <input type="text" class="form-control input text required" name="billing_postcode" id="billing_postcode" value="{if $fields.billing_postcode}{$fields.billing_postcode}{/if}" />
            </div>
